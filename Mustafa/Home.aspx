...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        body {
            ...
            background: -webkit-gradient(radial, center center, 0, center center, 460, from(#fff8cc), to(#bfb888));
            /* Safari 5.1+, Chrome 10+ */
            background: -webkit-radial-gradient(circle, #fff8cc, #bfb888);
            /* Firefox 3.6+ */
            background: -moz-radial-gradient(circle, #fff8cc, #bfb888);
            /* IE 10 */
            background: -ms-radial-gradient(circle, #fff8cc, #bfb888);
            height: 600px;
        }
        ...
        .centered-form {
            ...
            .centered-form .panel {
                background: rgba(80, 205, 225, 0.8);
