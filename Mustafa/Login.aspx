...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <style type="text/css">
        body {
            ...
            background: -webkit-gradient(radial, center center, 0, center center, 460, from(#e3c819), to(#20261a));
            /* Safari 5.1+, Chrome 10+ */
            background: -webkit-radial-gradient(circle, #e3c819, #20261a);
            /* Firefox 3.6+ */
            background: -moz-radial-gradient(circle, #e3c819, #20261a);
            /* IE 10 */
            background: -ms-radial-gradient(circle, #e3c819, #20261a);
            height: 600px;
        }
